...
<style>
  .header-container {
    ...
    align-items: center;
    background-color: #222d32; /* Change the background color */
    padding: 20px;
    border-radius: 5px;
    color: white;
  }
  ...
  .breadcrumb .active {
    color: #FFEB3B; /* Active breadcrumb color */
  }
</style>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <form action="import_candidates.php" method="POST" enctype="multipart/form-data">
